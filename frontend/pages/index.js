  ...
  return (
    <div className="container">
      <div className="header">
        <div className="brand">
          ...
          <div>
            ...
            <div className="subtitle">AI-assisted log parsing, classification and alerting</div>
          </div>
        </div>
        <div className="meta">Local dev UI — Backend: <code>http://localhost:8000/analyze</code></div>
      </div>
      ...
      <footer style={{marginTop:28,color:'var(--muted)',fontSize:13,textAlign:'center'}}>
        <div style={{maxWidth:900,margin:'8px auto'}}>Start backend with: <code>uvicorn src.api:app --reload --port 8000</code></div>
      </footer>
    </div>
  )
}
